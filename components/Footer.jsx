...
const Footer = () => (
  ...
  >
    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-auto flex-col gap-8`}>
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <p className="font-normal text-[14px] text-ahite opacity-50">
          ...
          <div className="flex gap-4">
            {socials.map((social) => (
              <img
                ...
                src={social.url}
                alt={social.name}
                className="w-[24px] h-[24p] object-contain cursor-pointer"
              />
            ))}
          </div>
        </div>
